...
const Leaderboard = () => {
  ...
  const allPlayers = [
    ...leaderboard,
    { rank: 9, name: 'Alex Horizon', xp: 1720, avatar: '👨‍🚀', isCurrentUser: false },
    { rank: 10, name: 'Luna Eclipse', xp: 1680, avatar: '👩‍🚀', isCurrentUser: false },
    { rank: 11, name: 'Nova Star', xp: 1620, avatar: '👨‍💻', isCurrentUser: false },
    { rank: 12, name: 'Cosmic Ray', xp: 1580, avatar: '👩‍💻', isCurrentUser: false },
  ];
  ...
  const getProgressData = () => [
    { name: 'Sarah Cosmic', change: '+120 XP', trend: 'up' },
    { name: 'David Stellar', change: '+95 XP', trend: 'up' },
    { name: 'Andi Pratama', change: '+85 XP', trend: 'up' },
    { name: 'Maya Galaxy', change: '+70 XP', trend: 'down' },
    { name: 'Rio Nebula', change: '+60 XP', trend: 'up' },
  ];
            ...
            <div className="mission-card p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {allPlayers.slice(0, 3).map((player, index) => (
                  ...
                  >
                    <div className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-br ${getRankBadgeColor(player.rank)} flex items-center justify-center text-2xl mb-3`}>
                      {player.avatar}
                    </div>
                    <div className="mb-2">
          ...
          <div className="space-y-6">
            ...
            <div className="mission-card p-6">
              ...
              <div className="space-y-3">
                {getProgressData().map((player, index) => (
